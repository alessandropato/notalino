...
abstract final class AnalysisPrompt {
  ...
  static const String version = 'analysis-v2';
...
- Potresti ricevere un blocco "CONTESTO FORNITO DALL'UTENTE" con informazioni sulla riunione (partecipanti, scopo, collegamenti con riunioni precedenti).
- Usalo per INTERPRETARE e CONTESTUALIZZARE la trascrizione: attribuisci correttamente gli interventi e gli action item alle persone indicate, riconosci lo scopo della riunione e i riferimenti al passato, e riflettilo nella sintesi.
- Il contesto è una guida di lettura, NON una fonte di contenuti: non trasformare le informazioni del contesto in decisioni/problematiche/azioni se non emergono anche dalla trascrizione.
''';
...
''';
  ...
  /// User message: incapsula il contesto (se presente) e la trascrizione.
  static String user(String transcript, {String? userContext}) {
    final String ctx = (userContext == null || userContext.trim().isEmpty)
        ? ''
        : 'CONTESTO FORNITO DALL\'UTENTE:\n${userContext.trim()}\n\n';
    return '${ctx}Trascrizione della riunione:\n\n$transcript';
  }
}
